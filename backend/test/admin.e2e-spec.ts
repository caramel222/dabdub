...
import { Merchant, MerchantStatus } from '../src/database/entities/merchant.entity';
import { Payment, PaymentStatus } from '../src/database/entities/payment.entity';
import { Settlement, SettlementStatus } from '../src/settlement/entities/settlement.entity';
...
describe('Admin Controller (e2e)', () => {
    ...
    describe('GET /api/v1/admin/merchants', () => {
        ...
        it('should filter merchants by status', () => {
            return request(app.getHttpServer())
                ...
                .expect(200)
                .expect((res) => {
                    expect(res.body.data.every((m: any) => m.status === MerchantStatus.ACTIVE)).toBe(true);
                });
        });
    ...
    describe('GET /api/v1/admin/payments', () => {
        ...
        it('should filter payments by merchant', () => {
            return request(app.getHttpServer())
                ...
                .expect(200)
                .expect((res) => {
                    expect(res.body.data.every((p: any) => p.merchantId === testMerchant.id)).toBe(true);
                });
        });
    ...
    describe('POST /api/v1/admin/settlements/:id/retry', () => {
        ...
        it('should return 404 for non-existent settlement', () => {
            return request(app.getHttpServer())
                .post('/api/v1/admin/settlements/00000000-0000-0000-0000-000000000000/retry')
                .set('Authorization', `Bearer ${adminToken}`)
                .expect(404);
        });
    });
