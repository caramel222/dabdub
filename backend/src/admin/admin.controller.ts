...
export class AdminController {
    ...
    @ApiOperation({
        ...
        description: 'Admin endpoint to list merchants with comprehensive filtering, search, and sorting capabilities',
    })
    ...
    @ApiOperation({
        ...
        description: 'Retrieve full merchant details including stats and related information',
    })
    ...
    @ApiOperation({
        ...
        description: 'Admin endpoint to view all payments across merchants with comprehensive filtering',
    })
    ...
    @ApiOperation({
        ...
        description: 'Admin endpoint to retry failed settlements with audit logging',
    })
    ...
    @ApiOperation({
        ...
        description: 'Detailed health status of all system components including database, Redis, blockchain, etc.',
    })
    ...
    @ApiOperation({
        ...
        description: 'Get aggregated metrics for merchants, payments, settlements, and system performance',
    })
    ...
    @ApiOperation({
        ...
        description: 'Admin endpoint to view audit logs with comprehensive filtering capabilities',
    })
    ...
    @ApiOperation({
        ...
        description: 'Admin endpoint to manually reconcile payments, settlements, or refunds with full audit trail',
    })
    ...
    async performManualReconciliation(
        ...
        const ipAddress = req.ip || req.socket.remoteAddress;
        return this.adminService.performManualReconciliation(dto, user.id, ipAddress);
    }
}
